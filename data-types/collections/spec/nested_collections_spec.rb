...
RSpec.describe 'Nested Collections' do
  ...
  it 'test 16' do
    ...
    # retrieve the expected piece of information
      ...
      three_day_forecast[:days].dig(0).each do |keys, values|
        actual << keys
      end
  ...
  it 'test 17' do
    ...
    actual = []
    three_day_forecast[:days][2].each do |keys, values|
      actual << values
    end
  ...
  it 'test 19' do
    ...
    actual =  # three_day_forecast[:days] #This is an array
              # three_day_forecast[:days][0] #This is a hash
    three_day_forecast[:days][0].replace({high: 99,low: 63,summary: "Mostly Sunny"})
